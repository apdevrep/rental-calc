...
export class CommercialProperty implements Property{
  constructor(
    ...
    public afterRepairedValue:number = 0, //percent
    ...
    public amortPeriod: number = 25,
    public initFixedPeriod: number = 7,
    public readjPeriod: number = 1,
    public initIntJump: number = 0.02,
    public otherIntJumps: number = 0.005,
    public maxIntRate: number = 0.04,
